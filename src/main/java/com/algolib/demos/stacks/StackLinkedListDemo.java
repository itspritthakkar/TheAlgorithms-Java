...
public class StackLinkedListDemo implements Demoable {

    Random rand = new Random();

    @Override
    public void start() {
        System.out.println("================= Stack Linked List demo =================");
    ...
    private void crudDemo() {
        try {
            Stack<Integer> sll = new StackLinkedList<>(ArrayHelper.generateRandomArray(10, 1, 20));
