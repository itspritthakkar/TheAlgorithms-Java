...
public class StackArrayListDemo implements Demoable {

    Random rand = new Random();

    @Override
    public void start() {
        System.out.println("================= Stack Array List demo =================");
    ...
    private void crudDemo() {
        try {
            Stack<Integer> sll = new StackArrayList<>(ArrayHelper.generateRandomArray(10, 1, 20));
